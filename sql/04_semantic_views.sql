...
-- Set fully qualified table name variables for semantic views
SET FQ_GUEST_360 = $FULL_PREFIX || '.GOLD.GUEST_360_VIEW_ENHANCED';
SET FQ_PERSONALIZATION_SCORES = $FULL_PREFIX || '.GOLD.PERSONALIZATION_SCORES_ENHANCED';
SET FQ_AMENITY_ANALYTICS = $FULL_PREFIX || '.GOLD.AMENITY_ANALYTICS';
