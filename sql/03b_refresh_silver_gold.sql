-- ============================================================================
-- Hotel Personalization - Refresh Silver and Gold Layers
-- ============================================================================
...
--
-- This script extracts and re-executes the CREATE OR REPLACE TABLE statements
-- from 02_schema_setup.sql for Silver and Gold layers only.
-- 
