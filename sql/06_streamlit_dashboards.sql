...
CREATE OR REPLACE STREAMLIT GUEST_360_DASHBOARD
    ...
    QUERY_WAREHOUSE = IDENTIFIER($FULL_PREFIX || '_WH')
...
GRANT USAGE ON STREAMLIT GUEST_360_DASHBOARD TO ROLE IDENTIFIER($FULL_PREFIX || '_ROLE');
GRANT USAGE ON STREAMLIT PERSONALIZATION_HUB TO ROLE IDENTIFIER($FULL_PREFIX || '_ROLE');
GRANT USAGE ON STREAMLIT AMENITY_PERFORMANCE TO ROLE IDENTIFIER($FULL_PREFIX || '_ROLE');
GRANT USAGE ON STREAMLIT REVENUE_ANALYTICS TO ROLE IDENTIFIER($FULL_PREFIX || '_ROLE');
GRANT USAGE ON STREAMLIT EXECUTIVE_OVERVIEW TO ROLE IDENTIFIER($FULL_PREFIX || '_ROLE');

-- Admin role gets access to all dashboards
GRANT USAGE ON STREAMLIT GUEST_360_DASHBOARD TO ROLE IDENTIFIER($FULL_PREFIX || '_ROLE_ADMIN');
GRANT USAGE ON STREAMLIT PERSONALIZATION_HUB TO ROLE IDENTIFIER($FULL_PREFIX || '_ROLE_ADMIN');
GRANT USAGE ON STREAMLIT AMENITY_PERFORMANCE TO ROLE IDENTIFIER($FULL_PREFIX || '_ROLE_ADMIN');
GRANT USAGE ON STREAMLIT REVENUE_ANALYTICS TO ROLE IDENTIFIER($FULL_PREFIX || '_ROLE_ADMIN');
GRANT USAGE ON STREAMLIT EXECUTIVE_OVERVIEW TO ROLE IDENTIFIER($FULL_PREFIX || '_ROLE_ADMIN');

-- Guest Analyst role
GRANT USAGE ON STREAMLIT GUEST_360_DASHBOARD TO ROLE IDENTIFIER($FULL_PREFIX || '_ROLE_GUEST_ANALYST');

-- Revenue Analyst role
GRANT USAGE ON STREAMLIT PERSONALIZATION_HUB TO ROLE IDENTIFIER($FULL_PREFIX || '_ROLE_REVENUE_ANALYST');
GRANT USAGE ON STREAMLIT REVENUE_ANALYTICS TO ROLE IDENTIFIER($FULL_PREFIX || '_ROLE_REVENUE_ANALYST');
GRANT USAGE ON STREAMLIT EXECUTIVE_OVERVIEW TO ROLE IDENTIFIER($FULL_PREFIX || '_ROLE_REVENUE_ANALYST');

-- Experience Analyst role
GRANT USAGE ON STREAMLIT AMENITY_PERFORMANCE TO ROLE IDENTIFIER($FULL_PREFIX || '_ROLE_EXPERIENCE_ANALYST');
GRANT USAGE ON STREAMLIT GUEST_360_DASHBOARD TO ROLE IDENTIFIER($FULL_PREFIX || '_ROLE_EXPERIENCE_ANALYST');
